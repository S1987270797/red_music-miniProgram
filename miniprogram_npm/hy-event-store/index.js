...
__DEFINE__(1648452141951, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1648452141952,"./event-store":1648452141953}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648452141952, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1648452141953, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1648452141952,"./utils":1648452141954}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648452141954, function(require, module, exports) {
...
return __REQUIRE__(1648452141951);
})()
